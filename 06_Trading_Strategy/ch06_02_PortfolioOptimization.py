...
import sys, os
IMPORT_PATH = os.path.dirname(os.path.abspath(os.path.dirname(__file__)))
sys.path.append('{}\\05_Stock_Price_API'.format(IMPORT_PATH))
...
df = pd.DataFrame()
for s in stocks:
    df[s] = mk.get_daily_price(s, '2021-01-04', '2022-12-28')['close']
